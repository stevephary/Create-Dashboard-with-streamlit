This repo provides a Python script (analysis.py) that utilizes the Streamlit library to create an interactive web application for visualizing and analyzing data through graphs.
